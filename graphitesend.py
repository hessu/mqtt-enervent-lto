...
class GraphiteClient(object):
    ...
    def __init__(self, prefix=None, graphite_server=None, graphite_port=2003,
                 ...
                 fqdn_squash=False,
                 use_ssl=False, ssl_ca_file=None, ssl_key_file=None, ssl_cert_file=None,
                 dryrun=False):
        """ 
        ...
        if use_ssl:
            ...
            if ssl_ca_file:
                self.ssl_context.load_verify_locations(ssl_ca_file)
            if ssl_key_file:
                self.ssl_context.load_cert_chain(ssl_cert_file, keyfile=ssl_key_file, password=None)
    ...
    def connect(self):
        ...
        try:
            ...
            if self.ssl_context and local_socket:
                local_socket = self.ssl_context.wrap_socket(local_socket, server_hostname=self.graphite_server)
